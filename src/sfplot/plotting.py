...
from .utils import map_cluster_to_celltype  # 假设你有一个 utils 模块存放辅助函数


def generate_cluster_distance_heatmap(base_path: str, sample: str, output_dir: Optional[str] = None):
    """
